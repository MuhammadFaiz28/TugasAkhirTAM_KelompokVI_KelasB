...
public class AnnouncementActivity extends AppCompatActivity{
    ...
    String hariIni;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            cvHead.setOnClickListener((View.OnClickListener) this);
            cvSports.setOnClickListener((View.OnClickListener) this);
            cvTechno.setOnClickListener((View.OnClickListener) this);
            cvBusiness.setOnClickListener((View.OnClickListener) this);
            cvHealth.setOnClickListener((View.OnClickListener) this);
            cvEntertaiment.setOnClickListener((View.OnClickListener) this);
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.cardHeadLine) {
                Intent intent = new Intent(AnnouncementActivity.this, HeadLineActivity.class);
                startActivity(intent);
            } else if (v.getId() == R.id.cardSports) {
                Intent intent = new Intent(AnnouncementActivity.this, SportsNewsActivity.class);
                startActivity(intent);
            } else if (v.getId() == R.id.cardTechno) {
                Intent intent = new Intent(AnnouncementActivity.this, TechnologyActivity.class);
                startActivity(intent);
            } else if (v.getId() == R.id.cardBusiness) {
                Intent intent = new Intent(AnnouncementActivity.this, BusinessActivity.class);
                startActivity(intent);
            } else if (v.getId() == R.id.cardHealth) {
                Intent intent = new Intent(AnnouncementActivity.this, HealthActivity.class);
                startActivity(intent);
            } else if (v.getId() == R.id.cardEnter) {
                Intent intent = new Intent(AnnouncementActivity.this, EntertaimentActivity.class);
                startActivity(intent);
            }
        }
